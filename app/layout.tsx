  ...
  return (
    <html lang="en">
      <body className="bg-gray-50 min-h-screen">
        ...
        >
          <div className="flex">
            <a href="/" className="flex-1 flex flex-col items-center gap-1 py-4 text-slate-500 active:text-slate-900 active:bg-gray-100" style={{ minHeight: '64px' }}>
              <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
              </svg>
              <span className="text-sm font-medium">Home</span>
            </a>
            <a href="/clients/new" className="flex-1 flex flex-col items-center gap-1 py-4 text-slate-500 active:text-slate-900 active:bg-gray-100" style={{ minHeight: '64px' }}>
              <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4" />
              </svg>
              <span className="text-sm font-medium">Add</span>
            </a>
            <a href="/jobs" className="flex-1 flex flex-col items-center gap-1 py-4 text-slate-500 active:text-slate-900 active:bg-gray-100" style={{ minHeight: '64px' }}>
              <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
              </svg>
              <span className="text-sm font-medium">Jobs</span>
            </a>
            <a href="/analytics" className="flex-1 flex flex-col items-center gap-1 py-4 text-slate-500 active:text-slate-900 active:bg-gray-100" style={{ minHeight: '64px' }}>
              <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
